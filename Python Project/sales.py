...
st.markdown("<h2> Sales Prediction Using Machine Learning</h2>", unsafe_allow_html=True)

st.divider()

st.markdown("""
<h3>Introduction</h3>
<p>This project aims to predict sales for  stores using historical sales data. The goal is to develop a machine learning model that can accurately forecast future sales, helping shopsd to optimize their inventory and staffing.</p>
...
# # Replace 'path_to_your_lottie_file.json' with the actual file path
# # lottie_animation = load_lottie_file('walmart_animation.json')  # Commented out

# # Display the Lottie animation in Streamlit
# # st_lottie(lottie_animation, height=300, key="shopping_cart")  # Commented out
...
#     <li>Visualizing sales trends over time.</li>
#     <li>Analyzing the impact of holidays on sales.</li>
#     <li>Investigating correlations betwestreamlit run /Users/rishiguptha/Desktop/Walmart/walmart.pystreen sales and other features.</li>
# </ul>
...
# <ol>
#     <li><b>Data Preprocessing</b>: Cleaning the data, handling missing values, and feature engineering.</li>
#     <li><b>Model Selection</b>: Trying out different algorithms such as Linear Regression, Decision Tree, Support Vector Regression(SVR) , K
# </ol>
# """)
